...
export const Wave = ({ color }: Props) => {
  return (
      <svg id="visual" viewBox="0 0 900" width="auto" height="170" xmlns="http://www.w3.org/2000/svg" version="1.1">
        <path
          ...
          fill={color} stroke-linecap="round" stroke-linejoin="miter"></path>
      </svg>
  );
};
